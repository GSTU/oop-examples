...
namespace WindowsFormsApplication1
{
    class Game
    {
        ...
        public void dr15(Graphics g,Pen p,int n,int pos,Font f)
        {
            ...
            g.FillRectangle(new SolidBrush(Form1.config.ThemeColor), xy[0, 0] + 7, xy[0, 1] + 7, 67, 67);
            string s = "" + n;
            g.DrawString(s, f, new SolidBrush(Form1.config.LetterColor), xy[0, 0] + 18, xy[0, 1] + 18);
