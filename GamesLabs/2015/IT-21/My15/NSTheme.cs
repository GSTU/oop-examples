...
class NSButton : Control {
    ...
    protected override void OnPaint(System.Windows.Forms.PaintEventArgs e) {
        ...
        G.DrawString(Text, Font, Brushes.Black, Width / 2 - O.Width / 2 + 1, Height / 2 - O.Height / 2 + 2);
        G.DrawString(Text, Font, Brushes.White, Width / 2 - O.Width / 2, Height / 2 - O.Height / 2 + 1);
    }
...
class NSProgressBar : Control {
    ...
    protected override void OnPaint(System.Windows.Forms.PaintEventArgs e) {
        ...
        I1 = Convert.ToInt32((float)Width / (float)_Maximum * _Value);
